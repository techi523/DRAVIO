...
/**
 * Routes payment requests to the correct provider based on payment method.
 */
export class PaymentRouter {
  async createPaymentIntent(
    ...
    switch (normalizedMethod) {
      ...
      case 'm-pesa':
      case 'mobile_money': {
        // Convert USD to KES for M-Pesa (use real exchange rate in production)
        ...
        return {
          providerRef: result.providerRef,
          checkoutUrl: '', // STK Push is phone-initiated, no URL needed
          providerType: 'mpesa',
        };
      }
