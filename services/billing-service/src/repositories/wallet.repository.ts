...
export class WalletRepository {
  /**
   * Retrieves the current main balance (excluding frozen escrow limits).
   */
  ...
  /**
   * Locks the initial escrow for a new connection session.
   * Ensures the user has enough real balance.
   */
  ...
  /**
   * Commits the final cost drawn from real funds and releases the active escrow block.
   */
  ...
  /**
   * Directly deduct funds sequentially (used for real-time live deductions without escrow)
   */
  ...
  /**
   * Top up main balance manually (e.g. via M-Pesa).
   */
