...
function AdminDashboard() {
    return (<div className="p-8 space-y-8">
      ...
      <div className="grid grid-cols-4 gap-6">
        ...
        ].map((kpi, i) => (<div key={i} className="tactical-border p-6 rounded-lg">
      ...
      <div className="grid grid-cols-3 gap-8">
        ...
        <div className="col-span-2 tactical-border rounded-lg p-6">
          ...
          <div className="space-y-4">
            {[1, 2, 3, 4, 5].map(i => (<div key={i} className="flex justify-between items-center py-3 border-b border-white/5 text-xs font-mono">
        ...
        <div className="tactical-border rounded-lg p-6">
          ...
          <div className="space-y-4">
            {["Auth", "Session", "Marketplace", "Payment", "Metering", "ISP-GW"].map((s, i) => (<div key={i} className="flex justify-between items-center">
