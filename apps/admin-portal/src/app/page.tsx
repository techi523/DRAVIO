                ...
                <div className="tactical-panel">
                    ...
                    <div className="space-y-4 mt-4">
                        <div className="flex justify-between items-center text-sm border-b border-[rgba(255,255,255,0.05)] pb-2">
                            <div>
                                <span className="text-[#00ff66]">NODE_JOIN</span>
                                <div className="text-xs text-gray-500">Frankfurt-01</div>
                            </div>
                            <span className="text-xs text-gray-400">2 min ago</span>
                        </div>
                        <div className="flex justify-between items-center text-sm border-b border-[rgba(255,255,255,0.05)] pb-2">
                            <div>
                                <span className="text-[#00f2ff]">ROUTING_UPDATE</span>
                                <div className="text-xs text-gray-500">Optimized Asia routes</div>
                            </div>
                            <span className="text-xs text-gray-400">15 min ago</span>
                        </div>
                        <div className="flex justify-between items-center text-sm border-b border-[rgba(255,255,255,0.05)] pb-2">
                            <div>
                                <span className="text-[#ffb800]">HIGH_LOAD</span>
                                <div className="text-xs text-gray-500">Node US-East-3</div>
                            </div>
