export default function ComplianceManager() {
  return (
    <div className="p-8 space-y-8 text-xs font-mono">
      ...
      <div className="grid grid-cols-3 gap-8">
        ...
        <div className="col-span-2 space-y-6">
          ...
          <div className="space-y-4">
            {[1, 2, 3].map(i => (
              <div key={i} className="tactical-border p-6 rounded-lg flex justify-between items-center group hover:border-warning/40 transition-all">
        ...
        <div className="space-y-6">
          ...
          <div className="tactical-border p-6 rounded-lg space-y-4">
            {["Payment", "KYC", "Admin_Login", "Session_Kill", "Balance_Adj"].map(f => (
