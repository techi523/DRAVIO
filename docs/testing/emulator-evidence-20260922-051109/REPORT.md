# DRAVIO Emulator Test Evidence - 20260922-051109
...
| node_modules | PASS | present at C:\Users\Admin\Desktop\DRAVIO\apps\mobile-app\node_modules |
| API: Local backend 127.0.0.1:8080 | DOWN | unreachable: Unable to connect to the remote server |
| API: Prod API | DOWN | unreachable: The operation has timed out. |
...
| Emulator: gateway 10.0.2.2 | PASS | PING 10.0.2.2 (10.0.2.2) 56(84) bytes of data. 64 bytes from 10.0.2.2: icmp_seq=1 ttl=255 time=6.68 ms  --- 10.0.2.2 ping statistics --- 1 packets transmitted, 1 received, 0% packet loss, time 0ms rtt min/avg/max/mdev = 6.683/6.683/6.683/0.000 ms |
...
| App launched | PASS |   ResumedActivity: ActivityRecord{12310119 u0 com.dravio.app/.MainActivity t37} |
| Initial screen render | PASS | text: DRAVIO | DECENTRALIZED INTERNET MARKETPLACE | G Google | ï£¿ Apple | GH GitHub | M Microsoft | &#128241; Continue with Phone | or continue with email | EMAIL | you@example.com | PASSWORD | Your password | &#128584; | LOG |
| Initial screen error-state check | INFO | error signals:  |
| Tab 1 render | PASS | text: DRAVIO | DECENTRALIZED INTERNET MARKETPLACE | G Google | ï£¿ Apple | GH GitHub | M Microsoft | &#128241; Continue with Phone | or continue with email | EMAIL | you@example.com | PASSWORD | Your password | &#128584; | LOG |
| Tab 2 render | PASS | text: DRAVIO | DECENTRALIZED INTERNET MARKETPLACE | G Google | ï£¿ Apple | GH GitHub | M Microsoft | &#128241; Continue with Phone | or continue with email | EMAIL | you@example.com | PASSWORD | Your password | &#128584; | LOG |
...
| meminfo | INFO |  TOTAL PSS: 226135 TOTAL RSS: 348144 TOTAL SWAP PSS: 280 |
| Screenshots captured | INFO | 6 PNGs in C:\Users\Admin\Desktop\DRAVIO\docs\testing\emulator-evidence-20260922-051109 |
